...
const uglify = require('uglifyjs-webpack-plugin') // used to make you code look ugly good for machine efficiency
...
module.exports = {
	...
	devtool:'inline-source-map',// indicate error during the bundling process
	devServer:{// using these properties when using webpack-dev-server
		contentBase:'./dist',
		hot:true
	},
	module:{
